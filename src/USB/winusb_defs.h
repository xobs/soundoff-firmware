...
struct winusb_extended_property_header
{
    uint32_t dwLength;
    uint16_t bcdVersion;
    uint16_t wIndex;
...
struct winusb_extended_property_section_header
{
    uint32_t dwSize;
...
#define WINUSB_DESCRIPTOR_SET_INFORMATION_SIZE 8
...
#define WINUSB_PLATFORM_DESCRIPTOR_HEADER_SIZE 20
...
#define WINUSB_PROP_DATA_TYPE_REG_MULTI_SZ 7
